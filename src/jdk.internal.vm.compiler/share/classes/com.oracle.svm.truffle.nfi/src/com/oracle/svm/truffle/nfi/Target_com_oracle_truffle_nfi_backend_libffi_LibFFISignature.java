...
@TargetClass(className = "com.oracle.truffle.nfi.backend.libffi.LibFFISignature", onlyWith = TruffleNFIFeature.IsEnabled.class)
final class Target_com_oracle_truffle_nfi_backend_libffi_LibFFISignature {

    @Alias long cif;
    @Alias Target_com_oracle_truffle_nfi_backend_libffi_LibFFISignature_CachedSignatureInfo signatureInfo;
}
