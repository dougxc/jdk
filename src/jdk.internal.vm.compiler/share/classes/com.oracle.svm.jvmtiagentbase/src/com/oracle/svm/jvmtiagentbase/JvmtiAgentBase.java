 ...
 * <li>Create a {@link jdk.internal.vm.compiler.nativeimage.hosted.Feature} that will register the agent using
 * {@link #registerAgent(JvmtiAgentBase)} in its'
 * {@link jdk.internal.vm.compiler.nativeimage.hosted.Feature#afterRegistration} callback.</li>
 * </ol>
