...
import jdk.internal.vm.compiler.libgraal.jni.LibGraalNativeBridgeSupport;
...
import jdk.internal.vm.compiler.nativeimage.LogHandler;
import jdk.internal.vm.compiler.nativeimage.StackValue;
import jdk.internal.vm.compiler.nativeimage.VMRuntime;
...
import jdk.internal.vm.compiler.nativeimage.hosted.RuntimeReflection;
        ...
        try {
            ...
            if (LibGraalEntryPoints.hasLibGraalIsolatePeer()) {
                ...
                JNI.JClass libGraalIsolateClass = JNIUtil.findClass(env, JNIUtil.getJVMCIClassLoader(env),
                                JNIUtil.getBinaryName("jdk.internal.vm.compiler.libgraal.LibGraalIsolate"), true);
