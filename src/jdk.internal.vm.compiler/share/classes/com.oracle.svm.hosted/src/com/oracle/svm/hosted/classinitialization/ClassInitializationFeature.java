...
public class ClassInitializationFeature implements GraalFeature {
    ...
    private static void initializeNativeImagePackagesAtBuildTime(ClassInitializationSupport initializationSupport) {
        ...
        initializationSupport.initializeAtBuildTime("jdk.internal.vm.compiler.collections", "Native Image classes are always initialized at build time");
        ...
        initializationSupport.initializeAtBuildTime("jdk.internal.vm.compiler.word", "Native Image classes are always initialized at build time");
        initializationSupport.initializeAtBuildTime("jdk.internal.vm.compiler.nativeimage", "Native Image classes are always initialized at build time");
        ...
        initializationSupport.initializeAtBuildTime("jdk.internal.vm.compiler.options", "Native Image classes are always initialized at build time");
    }
