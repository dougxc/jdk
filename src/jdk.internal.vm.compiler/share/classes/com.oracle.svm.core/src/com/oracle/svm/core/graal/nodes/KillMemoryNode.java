...
public class KillMemoryNode extends FixedWithNextNode implements SingleMemoryKill, LIRLowerable {
    ...
    protected KillMemoryNode(LocationIdentity killedIdentity) {
        super(TYPE, StampFactory.forVoid());
        this.killedIdentity = killedIdentity;
    }
    ...
    @NodeIntrinsic
    public static native void killMemory(@ConstantNodeParameter LocationIdentity killedIdentity);
}
