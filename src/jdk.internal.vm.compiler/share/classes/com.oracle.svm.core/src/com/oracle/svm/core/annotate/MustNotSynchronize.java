...
/**
 * Methods annotated with <code>@MustNotSynchronize(MustNotSynchronize.BLACKLIST)</code> may not
 * synchronize, nor may any of their transitive callees unless that callee is annotated with
 * <code>@MustNotSynchronize(MustNotSynchronize.WHITELIST)</code>.
 */
@Retention(RetentionPolicy.RUNTIME)
@Target({ElementType.METHOD, ElementType.CONSTRUCTOR})
public @interface MustNotSynchronize {
